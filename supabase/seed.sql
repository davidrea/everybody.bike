...
insert into public.riders (id, first_name, last_name, group_id, date_of_birth) values
  -- Taylor Williams' kids
  ('b1b2c3d4-0001-4000-8000-000000000001', 'Emma',   'Williams', 'a1b2c3d4-0001-4000-8000-000000000001', '2015-03-12'),
  ('b1b2c3d4-0002-4000-8000-000000000002', 'Liam',   'Williams', 'a1b2c3d4-0002-4000-8000-000000000002', '2017-07-28'),
  -- Morgan Garcia's kid
  ('b1b2c3d4-0003-4000-8000-000000000003', 'Sophia', 'Garcia',   'a1b2c3d4-0003-4000-8000-000000000003', '2016-11-04'),
  -- Sam Patel's kid
  ('b1b2c3d4-0004-4000-8000-000000000004', 'Noah',   'Patel',    'a1b2c3d4-0001-4000-8000-000000000001', '2014-09-22'),
  -- Shared-custody kid: linked to Taylor Williams AND Morgan Garcia
  ('b1b2c3d4-0005-4000-8000-000000000005', 'Ava',    'Martinez', 'a1b2c3d4-0002-4000-8000-000000000002', '2016-05-15');

-- Additional riders for larger rosters (up to ~20 per group)
insert into public.riders (
  id, first_name, last_name, group_id, date_of_birth, medical_notes, media_opt_out
) values
  -- Shredders
  ('b1b2c3d4-0101-4000-8000-000000000101', 'Aiden',  'Blake',    'a1b2c3d4-0001-4000-8000-000000000001', '2014-04-10', 'Asthma', false),
  ('b1b2c3d4-0102-4000-8000-000000000102', 'Harper', 'Cole',     'a1b2c3d4-0001-4000-8000-000000000001', '2015-02-19', null, false),
  ('b1b2c3d4-0103-4000-8000-000000000103', 'Mason',  'Dale',     'a1b2c3d4-0001-4000-8000-000000000001', '2014-11-03', null, false),
  ('b1b2c3d4-0104-4000-8000-000000000104', 'Zoe',    'Ellis',    'a1b2c3d4-0001-4000-8000-000000000001', '2016-01-25', 'Peanut allergy', false),
  ('b1b2c3d4-0105-4000-8000-000000000105', 'Lucas',  'Ford',     'a1b2c3d4-0001-4000-8000-000000000001', '2015-06-14', null, false),
  ('b1b2c3d4-0106-4000-8000-000000000106', 'Nora',   'Gray',     'a1b2c3d4-0001-4000-8000-000000000001', '2016-09-02', null, false),
  ('b1b2c3d4-0107-4000-8000-000000000107', 'Owen',   'Hall',     'a1b2c3d4-0001-4000-8000-000000000001', '2015-12-08', null, false),
  ('b1b2c3d4-0108-4000-8000-000000000108', 'Mia',    'Ivers',    'a1b2c3d4-0001-4000-8000-000000000001', '2016-03-17', null, false),
  ('b1b2c3d4-0109-4000-8000-000000000109', 'Caleb',  'Jones',    'a1b2c3d4-0001-4000-8000-000000000001', '2014-05-29', null, false),
  ('b1b2c3d4-0110-4000-8000-000000000110', 'Layla',  'Kerr',     'a1b2c3d4-0001-4000-8000-000000000001', '2015-07-11', null, false),
  ('b1b2c3d4-0111-4000-8000-000000000111', 'Jack',   'Lane',     'a1b2c3d4-0001-4000-8000-000000000001', '2014-08-21', null, false),
  ('b1b2c3d4-0112-4000-8000-000000000112', 'Ivy',    'Moore',    'a1b2c3d4-0001-4000-8000-000000000001', '2016-10-30', null, false),
  ('b1b2c3d4-0113-4000-8000-000000000113', 'Ethan',  'Nash',     'a1b2c3d4-0001-4000-8000-000000000001', '2015-01-09', null, false),
  ('b1b2c3d4-0114-4000-8000-000000000114', 'Aria',   'Olsen',    'a1b2c3d4-0001-4000-8000-000000000001', '2016-04-22', null, false),
  ('b1b2c3d4-0115-4000-8000-000000000115', 'Ryan',   'Park',     'a1b2c3d4-0001-4000-8000-000000000001', '2014-12-01', null, true),
  ('b1b2c3d4-0116-4000-8000-000000000116', 'Chloe',  'Quinn',    'a1b2c3d4-0001-4000-8000-000000000001', '2015-03-05', null, false),
  ('b1b2c3d4-0117-4000-8000-000000000117', 'Eli',    'Reed',     'a1b2c3d4-0001-4000-8000-000000000001', '2016-06-18', null, false),

  -- Trail Blazers
  ('b1b2c3d4-0201-4000-8000-000000000201', 'Lily',   'Stone',    'a1b2c3d4-0002-4000-8000-000000000002', '2014-02-12', 'Type 1 diabetes', false),
  ('b1b2c3d4-0202-4000-8000-000000000202', 'Ben',    'Turner',   'a1b2c3d4-0002-4000-8000-000000000002', '2015-05-27', null, false),
  ('b1b2c3d4-0203-4000-8000-000000000203', 'Grace',  'Underwood','a1b2c3d4-0002-4000-8000-000000000002', '2016-07-08', null, false),
  ('b1b2c3d4-0204-4000-8000-000000000204', 'Wyatt',  'Vale',     'a1b2c3d4-0002-4000-8000-000000000002', '2015-09-19', null, false),
  ('b1b2c3d4-0205-4000-8000-000000000205', 'Ella',   'West',     'a1b2c3d4-0002-4000-8000-000000000002', '2014-11-30', null, false),
  ('b1b2c3d4-0206-4000-8000-000000000206', 'Jonah',  'Xu',       'a1b2c3d4-0002-4000-8000-000000000002', '2016-01-14', null, false),
  ('b1b2c3d4-0207-4000-8000-000000000207', 'Paige',  'Young',    'a1b2c3d4-0002-4000-8000-000000000002', '2015-04-03', null, false),
  ('b1b2c3d4-0208-4000-8000-000000000208', 'Finn',   'Zane',     'a1b2c3d4-0002-4000-8000-000000000002', '2016-08-26', null, false),
  ('b1b2c3d4-0209-4000-8000-000000000209', 'Ruby',   'Adams',    'a1b2c3d4-0002-4000-8000-000000000002', '2014-06-11', null, false),
  ('b1b2c3d4-0210-4000-8000-000000000210', 'Carter', 'Brown',    'a1b2c3d4-0002-4000-8000-000000000002', '2015-02-07', null, false),
  ('b1b2c3d4-0211-4000-8000-000000000211', 'Stella', 'Cruz',     'a1b2c3d4-0002-4000-8000-000000000002', '2016-03-29', null, false),
  ('b1b2c3d4-0212-4000-8000-000000000212', 'Leo',    'Diaz',     'a1b2c3d4-0002-4000-8000-000000000002', '2014-12-22', null, false),
  ('b1b2c3d4-0213-4000-8000-000000000213', 'Hazel',  'Evans',    'a1b2c3d4-0002-4000-8000-000000000002', '2015-10-05', null, false),
  ('b1b2c3d4-0214-4000-8000-000000000214', 'Miles',  'Finch',    'a1b2c3d4-0002-4000-8000-000000000002', '2016-02-16', null, true),
  ('b1b2c3d4-0215-4000-8000-000000000215', 'Isla',   'Grant',    'a1b2c3d4-0002-4000-8000-000000000002', '2014-09-09', null, false),
  ('b1b2c3d4-0216-4000-8000-000000000216', 'Theo',   'Hart',     'a1b2c3d4-0002-4000-8000-000000000002', '2015-06-01', null, false),
  ('b1b2c3d4-0217-4000-8000-000000000217', 'Violet', 'Irwin',    'a1b2c3d4-0002-4000-8000-000000000002', '2016-11-12', null, false),

  -- Dirt Devils
  ('b1b2c3d4-0301-4000-8000-000000000301', 'Jude',   'Keller',   'a1b2c3d4-0003-4000-8000-000000000003', '2015-01-27', null, false),
  ('b1b2c3d4-0302-4000-8000-000000000302', 'Piper',  'Lewis',    'a1b2c3d4-0003-4000-8000-000000000003', '2016-05-20', 'Carries epinephrine', false),
  ('b1b2c3d4-0303-4000-8000-000000000303', 'Gavin',  'Miles',    'a1b2c3d4-0003-4000-8000-000000000003', '2014-10-14', null, false),
  ('b1b2c3d4-0304-4000-8000-000000000304', 'Sadie',  'Nolan',    'a1b2c3d4-0003-4000-8000-000000000003', '2015-04-09', null, false),
  ('b1b2c3d4-0305-4000-8000-000000000305', 'Colin',  'Ortiz',    'a1b2c3d4-0003-4000-8000-000000000003', '2016-07-01', null, false),
  ('b1b2c3d4-0306-4000-8000-000000000306', 'Willa',  'Perez',    'a1b2c3d4-0003-4000-8000-000000000003', '2014-03-26', null, false),
  ('b1b2c3d4-0307-4000-8000-000000000307', 'Rowan',  'Quinn',    'a1b2c3d4-0003-4000-8000-000000000003', '2015-12-18', null, false),
  ('b1b2c3d4-0308-4000-8000-000000000308', 'Lucy',   'Ross',     'a1b2c3d4-0003-4000-8000-000000000003', '2016-02-02', null, false),
  ('b1b2c3d4-0309-4000-8000-000000000309', 'Henry',  'Shaw',     'a1b2c3d4-0003-4000-8000-000000000003', '2014-09-28', null, false),
  ('b1b2c3d4-0310-4000-8000-000000000310', 'Tessa',  'Vaughn',   'a1b2c3d4-0003-4000-8000-000000000003', '2015-08-07', null, true),
